...
class AppAssets {
  ...
  // Products
  static final String freshPeach = AppConstants.imageUrl(
    'products/fresh_peach',
  );
  ...
  static final String blackGrapes = AppConstants.imageUrl(
    'products/black_grapes',
  );
  static final String pomegranate = AppConstants.imageUrl(
    'products/pomegranate',
  );
  static final String freshBroccoli = AppConstants.imageUrl(
    'products/fresh_broccoli',
  );
  ...
  // Categories
  static final String catVegetables = AppConstants.imageUrl(
    'categories/vegetables',
  );
  static final String catFruits = AppConstants.imageUrl('categories/fruits');
  static final String catBeverages = AppConstants.imageUrl(
    'categories/beverages',
  );
  static final String catGrocery = AppConstants.imageUrl('categories/grocery');
  static final String catEdibleOil = AppConstants.imageUrl(
    'categories/edible_oil',
  );
  static final String catHousehold = AppConstants.imageUrl(
