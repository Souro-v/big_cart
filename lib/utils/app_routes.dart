...
class AppRoutes {
  ...
  static Route<dynamic> generateRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      case forgotPass:    return _route(const ForgotPasswordScreen());
      case home:          return _route(const HomeScreen());
      case productDetail: return _route(const ProductDetailScreen());
      case category:      return _route(const CategoryScreen());
      case search:        return _route(const SearchScreen());
      case cart:          return _route(const CartScreen());
      case checkout:      return _route(const CheckoutScreen());
      case myOrders:      return _route(const MyOrdersScreen());
      case orderDetail:   return _route(const OrderDetailScreen());
