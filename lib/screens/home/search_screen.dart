...
class _SearchScreenState extends State<SearchScreen> {
  ...
  final List<String> _discoverMore = [
    'Fresh Grocery', 'Vegetables', 'Fruits',
    'Beverages', 'Household', 'Edible oil',
    'Grocery', 'Discount items',
  ];
                ...
                children: [
                  ...
                  if (history.isNotEmpty) ...[
                    ...
                    Wrap(
                      spacing: 8,
                      runSpacing: 8,
                      children: history.map((tag) => _SearchTag(
                        label: tag,
                        onTap: () => _onTagTap(tag),
                        onDelete: () => context
                            .read<SearchProvider>()
                  ...
                  Wrap(
                    spacing: 8,
                    runSpacing: 8,
                    children: _discoverMore.map((tag) => _SearchTag(
                      label: tag,
                      onTap: () => _onTagTap(tag),
                    )).toList(),
                  ),
